...
- OpenCV detection and tracking workflows
- Filtering, transformations, ROI extraction

### **Biomedical Imaging & Systems**

- CT/MRI analysis using 3D Slicer
- Volume reconstruction and label extraction
- Signal acquisition and processing (temperature, motion, pressure)
...
- Oscilloscope, multimeter, basic test rigs
- Low-power embedded architecture

### **Design & Product Development**

- Fusion 360, SolidWorks
- Rapid prototyping of enclosures and mechanical systems
- Ergonomic and functional fitment design

### **Data & Visualization Tools**

- Pandas, NumPy, Matplotlib, Seaborn
- Dashboard-style medical data visualization
